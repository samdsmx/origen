...
if ($Sesion){
	...
	$sql ="Create table Reporte select l.*, c.Edad,c.Religion,c.Sexo,c.Municipio,c.EstadoCivil,c.Estado,c.Ocupacion,c.ComoTeEnteraste,c.MedioContacto,c.CP,c.NivelViolencia from Casos c, Llamadas l where c.IDCaso=l.IDCaso $CadBusqueda2 $CadBusqueda";
	$total_result = @mysql_query($sql, $connection) or die("Error #". mysql_errno() . ": " . mysql_error());
	mysql_close($connection);
