...
//Class_Initialize Event @65-0CF54DAF
...
//CheckErrors Method @65-1E38455D
...
//Initialize Method @1-E551F8DB
    function Initialize()
    {
        ...
        // Create Components
        $this->html_header = & new clsControl(ccsLabel, "html_header", "html_header", ccsText, "", CCGetRequestParam("html_header", ccsGet), $this);
