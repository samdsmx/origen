...
class User extends Eloquent implements UserInterface, RemindableInterface {
    ...
    public static function validar($datos){
        $rules = array("nombres" => "required|regex:/^[a-zA-ZáéíóúñÁÉÍÓÚÑ][a-zA-ZáéíóúñÁÉÍÓÚÑ\s]*/", "apaterno" => "required|regex:/^[a-zA-ZáéíóúñÁÉÍÓÚÑ][a-zA-ZáéíóúñÁÉÍÓÚÑ\s]*/", "amaterno" => "regex:/^[a-zA-ZáéíóúñÁÉÍÓÚÑ][a-zA-ZáéíóúñÁÉÍÓÚÑ\s]*/", "curp" => 'required|regex:/^([A-Z]{4})([0-9]{6})([A-Z]{6})([0-9]{2})+$/', "correo" => "required|email", "telefono" => "required|digits:5", "ur" => "required|numeric", "usuario" => "required|regex:/^[a-zA-Z_\-\/0-9]+/", "pass" => "required|min:4|regex:/^[a-zA-Z_\-\/0-9]+/");
