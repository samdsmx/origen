...
/**
 * Description of UnidadesResponsablesController
 *
 * @author Angel
 */
class UnidadesResponsablesController extends BaseController {
    ...
    public function postBuscar() {
        if (Request::ajax()) {
            $ur = siaUnidadResponsableModel::find(Input::get('id'));
            if ($ur) {
    ...
    public function postEliminar() {
        ...
        $ur = siaUnidadResponsableModel::find(Input::get('modalConfirmaId'));
        if ($ur) {
            $ur->delete();
